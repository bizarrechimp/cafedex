  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="relative w-full h-[400px] mb-8 rounded-xl overflow-hidden bg-gray-200 dark:bg-gray-700 animate-pulse"></div>

        <div className="h-10 w-2/3 bg-gray-200 dark:bg-gray-700 rounded mb-4 animate-pulse"></div>
        ...
        <div className="h-20 w-full bg-gray-200 dark:bg-gray-700 rounded mb-8 animate-pulse"></div>
